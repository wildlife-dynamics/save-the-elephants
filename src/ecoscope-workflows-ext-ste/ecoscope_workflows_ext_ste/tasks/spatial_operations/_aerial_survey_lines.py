...
def ensure_polygon_type(gdf: AnyGeoDataFrame) -> AnyGeoDataFrame:  # assert_polygon_type
    ...
    """
    logger.info("Validating polygon geometries.")
...
def create_survey_transects(  # generate_survey_transects
    ...
    logger.info("Generating %s survey lines with %dm spacing.", direction, spacing)
    ...
    return cast(AnyGeoDataFrame, lines_gdf.to_crs(original_crs.to_wkt()))
