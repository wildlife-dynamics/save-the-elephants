...
ENTRYPOINT = "pixi run -e default ecoscope-workflows-general-elephant-report-workflow"
MATCHSPEC_OVERRIDE = "ecoscope-workflows-general-elephant-report-workflow"
