...
group_mapbook_maps_params = dict()
...
group_mapbook_maps = (
    groupbykey.set_task_instance_id("group_mapbook_maps")
    .handle_errors()
    .with_tracing()
    .skipif(
        conditions=[
...
# %% [markdown]
# ## Convert generated maps to pngs

# %%
# parameters

generate_map_png_params = dict()
...
generate_map_png = (
    html_to_png.set_task_instance_id("generate_map_png")
    .handle_errors()
    .with_tracing()
    .skipif(
        conditions=[
